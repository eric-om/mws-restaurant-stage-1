 ...
 */
fetchNeighborhoods = () => {
  APIHelper.fetchNeighborhoods((error, neighborhoods) => {
 ...
 */
fetchCuisines = () => {
  APIHelper.fetchCuisines((error, cuisines) => {
    if (error) { // Got an error!
      console.error(error);
    } else {
...
addMarkersToMap = (restaurants = self.restaurants) => {
  restaurants.forEach(restaurant => {
    ...
    const marker = APIHelper.mapMarkerForRestaurant(restaurant, self.map);
